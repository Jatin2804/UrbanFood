        ...
        <View style={styles.buttonsRow}>
          ...
          >
            <View style={[styles.iconCircle, styles.dineInIconCircle]}>
              <Ionicons name="restaurant-outline" size={26} color={Brand.primary} />
            </View>
            <ThemedText style={[styles.optionLabel, { color: theme.textPrimary }]}>
              Dine In
            </ThemedText>
          ...
          >
            ...
            <ThemedText style={[styles.optionSub, { color: 'rgba(255,255,255,0.75)' }]}>
              Pay at your door
            </ThemedText>
          </TouchableOpacity>
        </View>
